...
import ui.RecuperarPasswordScreen
import ui.RegistrarseScreen
    ...
    NavHost(navController = nav, startDestination = "homeRoot") {
        ...
        composable("homeRoot") {
            Scaffold( //layout base con zonas comunes (aquí solo topBar).
                topBar = { TopAppBar(title = { Text("Bakery APP") }) } // barra superior con el título.
...
private fun HomeContent(
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.logopng), //carga el drawable logo
